...
//            blue = random.nextInt(255);
    ...
    public static void main(String[] args) throws Exception {
        // 创建文件输出流对象
        OutputStream out = new FileOutputStream("E://test/" + System.currentTimeMillis() + ".jpg");
        Map<String, Object> map = VerificationCodeGeneration.generateCodeAndPic();
        ImageIO.write((RenderedImage) map.get("codePic"), "jpeg", out);
        System.out.println("验证码的值为：" + map.get("code"));
        System.out.println("验证码的值为：" + map.get("codePic"));
    }
}